...
FORBIDDEN = {
    "scanner_common":      {"scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "hfis", "market_story"},
    "scanner_observation": {"scanner_live", "min_scanner", "mil", "worldstate", "hfis", "market_story"},
    "system_ledger":       {"scanner_live", "min_scanner", "scanner_observation", "mil", "worldstate", "hfis", "market_story"},
    "min_scanner":         {"scanner_live", "mil", "worldstate", "hfis", "market_story"},
    ...
    "mil":                 {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "worldstate", "hfis", "market_story"},
    "hfis":                {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "market_story"},
    ...
    "worldstate":          {"scanner_live", "system_ledger", "mil", "hfis", "market_story"},
    ...
    "market_story":        {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "hfis"},
