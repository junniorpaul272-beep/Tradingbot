...
def build_world_state(state):
    ...
    # ---- structure.system_observation — ⚠ Phase 1B not built yet --------
    # Reserved None until the live facts digest exists. Deliberately NOT
    # recomputed here from candles (this function has none) — see
    # world_state_schema.md's "don't let the digest become a second state
    # machine" note. Once Phase 1B writes state["structure_digest"], this
    # line picks it up with no other change needed here.
