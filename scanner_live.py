    ...
    try:
        ...
        if events:
            ...
            push_text = hfis.narrate(
                events, understanding, intent_hypothesis,
                mil_understanding=state.get("mil_understanding"))
            if not push_text:
                push_text = format_market_event(events, understanding, intent_hypothesis)
            if push_text:
            ...
            _overview_pending = (_overview_pending + events)[-OVERVIEW_PENDING_EVENTS_MAX:]
