...
# touches zero API. /understand is a dev/audit surface only (per chat)
# — see brain.py's format_market_understanding() docstring.
from brain import build_market_understanding, format_market_understanding
...
def _answer_deferred_reports(deferred_report_cmds, state):
    ...
    /understand, /integrity commands from check_result_commands().
