...
class MarketThesis:
    ...
    Deliberately does NOT (yet) include Primary/Alternative/Competing
    Cases or Case File actual-vs-expected resolution tracking — those
    need leg_obs's forward-observation plumbing extended, a bigger,
    separate change held back for its own pass rather than rushed in
    alongside this one.
    """
    current_state: str
