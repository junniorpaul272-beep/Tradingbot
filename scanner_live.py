...
from scanner_common import (
    ...
    # ADDED (2026-08-27, per chat — Market Event lifecycle): cap for
    # state["market_event_pending"], written here, read/cleared by
    # _close_leg_obs() in min_scanner.py.
        ...
        if events:
            ...
            try:
                if _open_leg is not None:
                    ...
                    state["market_event_pending"] = pending[-MARKET_EVENT_PENDING_MAX:]
            except Exception as e:
