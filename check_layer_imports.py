...
FORBIDDEN = {
    "scanner_common":      {"scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "hfis"},
    "scanner_observation": {"scanner_live", "min_scanner", "mil", "worldstate", "hfis"},
    "system_ledger":       {"scanner_live", "min_scanner", "scanner_observation", "mil", "worldstate", "hfis"},
    "min_scanner":         {"scanner_live", "mil", "worldstate", "hfis"},
    ...
    "mil":                 {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "worldstate", "hfis"},
    "hfis":                {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate"},
    ...
    "worldstate":          {"scanner_live", "system_ledger", "mil", "hfis"},
