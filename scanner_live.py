...
def _build_and_send_overview(state, now_utc, header):
    ...
    try:
        ...
        if not push_text:
            ...
            # deep_thesis_text computed here, not inside min_scanner.py's
            # format_market_thesis() — see that function's docstring /
            # min_scanner.py's (removed) hfis import-site comment for why.
            push_text = format_market_thesis(
