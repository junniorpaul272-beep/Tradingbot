...
FORBIDDEN = {
    "scanner_common":      {"scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "hfis", "market_story", "narration_library"},
    "scanner_observation": {"scanner_live", "min_scanner", "mil", "worldstate", "hfis", "market_story", "narration_library"},
    "system_ledger":       {"scanner_live", "min_scanner", "scanner_observation", "mil", "worldstate", "hfis", "market_story", "narration_library"},
    "min_scanner":         {"scanner_live", "mil", "worldstate", "hfis", "market_story", "narration_library"},
    ...
    "mil":                 {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "worldstate", "hfis", "market_story", "narration_library"},
    "hfis":                {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "market_story", "narration_library"},
    ...
    "worldstate":          {"scanner_live", "system_ledger", "mil", "hfis", "market_story", "narration_library"},
    ...
    "market_story":        {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "hfis", "narration_library"},
    ...
    "narration_library":   {"scanner_common", "scanner_observation", "scanner_live", "min_scanner", "system_ledger", "mil", "worldstate", "hfis", "market_story"},
