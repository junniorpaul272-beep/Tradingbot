...
def classify_conviction(tier_label, score):
    ...
    live policy under audit, not as ground truth about setup quality.
    """
...
THESIS_UPDATE_HOURS_LOCAL     = [9, 12, 15]   # 9am / 12pm / 3pm local, every day — no weekend skip (per chat)
