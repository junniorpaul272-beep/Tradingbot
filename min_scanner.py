...
def format_market_thesis(state, understanding=None, deep_thesis_text=None):
    ...
    # narrate_overview() (the 9/12/3 push + /overview) is deliberately
    # light and stays that way; THIS is the surface meant to go deep.
    # Appended as its own section, not woven into `body` above, so a
    # missing/unpopulated MIL understanding degrades to exactly the old
    # /thesis output rather than a broken or truncated one.
